...
1. **Read `wiki/index.md`** — topics and article catalog; use it to identify relevant topics and articles. If the Articles table is empty, skip to step 2
2. **Read `wiki/<topic>/index.md`** for the relevant topics — lists articles within each topic for precise targeting
