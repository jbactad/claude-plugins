...
- **Concise**: Dense, human-readable content; one line per concept when possible. Target under 200 lines per file — bloated files cause Claude to ignore instructions
...
- **Splittable**: For larger projects, use `.claude/rules/*.md` for domain-specific rules or `@path/to/file` imports to keep the root CLAUDE.md lean
